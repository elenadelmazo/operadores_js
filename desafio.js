...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var redondearNumero = num.toFixed();
  return redondearNumero;
}
...
function esPositivo(numero) {
  ...
  //Si el número es positivo, devolver ---> "Es positivo" (numero > 0)
  //Si el número es negativo, devolver ---> "Es negativo" (numero < 0)
  //Si el número es 0, devuelve false (numero == 0)
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var exc = '!';
  var agregarSimboloExclamacion = str.concat(exc);
...
function obtenerSaludo(nombre) {
  ...
  var nombre = 'Martín';
  var exc = '!'
  var obtenerSaludo = saludar + nombre + exc;
